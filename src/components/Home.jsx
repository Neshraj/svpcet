...
function Home() {
  ...
  return (
    <>
      <Helmet>
        <title>
          SVPCET Student & Faculty Portal | College Management System
        </title>
        ...
        <meta
          property="og:image"
          content="https://svpcet.onrender.com/assets/tag.png"
        />
        ...
        <section className="py-12 px-4 max-w-6xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 text-gray-700">
            ...
            <div className="bg-white rounded-xl shadow-md p-6 hover:shadow-lg transition">
              ...
              <p>
                View schedules, track attendance, and access learning resources
                in real-time.
              </p>
            </div>
            <div className="bg-white rounded-xl shadow-md p-6 hover:shadow-lg transition">
